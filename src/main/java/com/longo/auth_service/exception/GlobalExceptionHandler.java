...
import com.longo.auth_service.error.ErrorResponse;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<com.longo.auth_service.error.ErrorResponse> handleAllException(Exception ex, WebRequest request) {
